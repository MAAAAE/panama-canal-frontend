...
const create = async () => {
  apiClient.post('/api/category', createCategory).then(async () => {
...
const deleteItem = () => {
  apiClient
    .delete(`/api/category/${deleteCategory.value.id}`)
    .then(async () => {
...
const update = () => {
  apiClient
    .put(`/api/category/${updateCategory.value.id}`, updateCategory.value)
    .then(async () => {
